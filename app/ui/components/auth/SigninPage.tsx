...
const Signin = (props: Props) => {
    ...
    return (
        <div className="max-w-screen-sm mx-auto py-6">
            <h1 className="text-white text-center text-2xl font-semibold rounded-md">
                Sign In
            </h1>

            {/* Success Message */}
            {successMsg ? (
                <div className="text-base-content py-2 mt-4">
            ...
            <form onSubmit={onSubmit} className="p-2 flex flex-col gap-4">
                ...
                <div className="flex flex-col space-y-2">
                    <label htmlFor="email" className="text-base-content text-md font-medium">
                        Email:
                    </label>
                ...
                {/* Password Input */}
                <div className="flex flex-col space-y-2">
                    <label htmlFor="password" className="text-base-content text-md font-medium">
                        Password:
                    </label>
